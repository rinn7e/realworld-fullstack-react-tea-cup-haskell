...
- **Example in this repo**: `e2e.yml`. It runs a full battery of functional tests against a real backend to ensure the app actually _works_ before or after a deployment.
