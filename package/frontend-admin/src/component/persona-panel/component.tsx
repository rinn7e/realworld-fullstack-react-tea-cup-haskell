...
import { ActionSectionMemo } from './sub-component/action-section'
import { BrowserInfoSectionMemo } from './sub-component/browser-info-section'
import { DialogueSectionMemo } from './sub-component/dialogue-section'
import { HeroSectionMemo } from './sub-component/hero-section'
import { PanelHeaderMemo } from './sub-component/panel-header'
...
const GearIconPropsEq: EqClass.Eq<GearIconProps> = EqClass.struct({
  className: S.Eq,
})

const GearIconComponent = ({ className }: GearIconProps) => (
  <svg
    ...
    <>
      ...
      >
        {model.isCollapse ? (
          ...
          >
            <GearIconMemo className='h-[20px] w-[20px] animate-[spin_10s_linear_infinite]' />
          </button>
        ) : (
          <div className='pb-[24px] pl-[24px]'>
            <div className='border-theme-primary/30 relative min-h-[600px] overflow-hidden rounded-[16px] border bg-black shadow-2xl'>
              <HeroSectionMemo
...
const GearIconMemo = memo(GearIconComponent, GearIconPropsEq.equals)

export const PersonaPanelMemo = memo(PersonaPanelComponent, PropsEq.equals)
