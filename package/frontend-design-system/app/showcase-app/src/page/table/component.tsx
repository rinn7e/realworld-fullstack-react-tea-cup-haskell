...
const TablePageComponent = ({ model, dispatch }: Props) => {
      ...
      <div className='flex w-full flex-col gap-6'>
        ...
        >
          <div className='w-full overflow-x-auto'>
            <DsTableMemo isBordered={true} isStriped={true} isHoverable={true}>
              <>
                <thead>
...
export const TablePageMemo = memo(TablePageComponent, PropsEq.equals)
