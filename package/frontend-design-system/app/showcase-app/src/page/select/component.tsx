import { SelectMemo } from '@rinn7e/realworld-design-system/form/select/component'
  ...
  return (
    <div data-component='SelectPage' className='w-full space-y-8 text-left'>
      <HeroMemo variant="default" size="small" className="rounded-lg bg-gray-50 border border-gray-200 px-6 py-6 w-full" children={() => (<><div className='mb-1 text-xs font-bold tracking-wider text-green-600 uppercase'>
            ...
            <TitleMemo size={2} className='mb-2 font-extrabold text-gray-900' children={() => 'Select'} />
