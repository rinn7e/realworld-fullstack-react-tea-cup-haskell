    ...
    <div data-component='SidebarPage' className='w-full space-y-8 text-left'>
      ...
      <div className='flex w-full flex-col gap-6'>
        ...
        {sectionView({
          ...
          boxClassName:
            'p-0 w-full bg-gray-50 border-2 border-dotted border-gray-300 dark:bg-zinc-950 dark:border-zinc-800 rounded-lg overflow-hidden h-[450px] flex',
          children: () => (
            <div className='flex h-full w-full'>
              ...
              <div className='flex-1 overflow-y-auto bg-white p-6 dark:bg-zinc-950'>
                <h4 className='mb-2 text-base font-bold text-gray-800 dark:text-zinc-200'>
                  Main Content Area
                </h4>
