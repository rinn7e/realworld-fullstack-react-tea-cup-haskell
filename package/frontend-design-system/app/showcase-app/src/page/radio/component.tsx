import { RadioMemo as DsRadioMemo } from '@rinn7e/realworld-design-system/form/radio/component'
...
export const RadioPage: React.FC<Props> = ({ model, dispatch }) => {
  ...
  return (
    <div data-component='RadioPage' className='w-full space-y-8 text-left'>
...
<><div className='mb-1 text-xs font-bold tracking-wider text-green-600 uppercase'>
            ...
            <DsTitleMemo size={2} className='mb-2 font-extrabold text-gray-900'>Radio</DsTitleMemo>
        ...
        {model.showCode && (
          <div className='relative w-full overflow-x-auto rounded-lg border border-gray-800 bg-gray-900 p-5 font-mono text-xs text-gray-100 shadow-lg'>
            <div className='mb-3 flex items-center justify-between border-b border-gray-800 pb-3 font-sans text-xs text-gray-400'>
              ...
              <span className='text-gray-500'>Radio Component Code</span>
            </div>
