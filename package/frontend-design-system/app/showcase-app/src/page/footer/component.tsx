...
const FooterPageComponent = ({ model, dispatch }: Props) => {
  const code = `{<DsFooterMemo />}`
  return (
    <div
      data-component='FooterPage'
    ...
    >
      ...
      <div className='flex w-full flex-col gap-6'>
        ...
        >
          <div className='w-full'>{<DsFooterMemo />}</div>
        </SectionViewMemo>
...
export const FooterPageMemo = memo(FooterPageComponent, PropsEq.equals)
