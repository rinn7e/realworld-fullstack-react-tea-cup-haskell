...
<><div className='mb-1 text-xs font-bold tracking-wider text-green-600 uppercase'>
            ...
            <DsTitleMemo size={2} className='mb-2 font-extrabold text-gray-900'>Footer</DsTitleMemo>
      ...
      <div className='flex w-full flex-col gap-6'>
        ...
        {sectionView({
          ...
          children: () => <div className='w-full'>{<DsFooterMemo />}</div> })}
