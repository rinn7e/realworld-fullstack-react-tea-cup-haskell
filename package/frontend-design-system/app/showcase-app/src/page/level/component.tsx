...
import { LevelMemo as DsLevelMemo } from '@rinn7e/realworld-design-system/layout/level/component'
...
const LevelPageComponent = ({ model, dispatch }: Props) => {
  const code = `{<DsLevelMemo
  children: (
    <div className='flex justify-between items-center w-full'>
      <span className='font-semibold text-gray-800 dark:text-zinc-200'>Left Alignment Item</span>
      <span className='text-sm text-green-600 font-bold'>Right Alignment Item</span>
    </div>
  ) })}`
  return (
    <div
      data-component='LevelPage'
...
export const LevelPageMemo = memo(LevelPageComponent, PropsEq.equals)
