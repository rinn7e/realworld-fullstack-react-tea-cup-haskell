...
const NavbarPageComponent = ({ model, dispatch }: Props) => {
    ...
    >
      ...
      <div className='flex w-full flex-col gap-6'>
        ...
        <SectionViewMemo
          ...
          boxClassName='px-0 pt-0 pb-6 w-full bg-white border-2 border-dotted border-gray-300 dark:bg-zinc-950 dark:border-zinc-800 dark:bg-zinc-950 dark:border-zinc-800 rounded-lg overflow-hidden'
        >
          <DsNavbarMemo
...
export const NavbarPageMemo = memo(NavbarPageComponent, PropsEq.equals)
