...
<><div className='mb-1 text-xs font-bold tracking-wider text-green-600 uppercase'>
            ...
            <DsTitleMemo size={2} className='mb-2 font-extrabold text-gray-900'>Input</DsTitleMemo>
        ...
        {sectionView({
          ...
          children: () => (
            <div className='w-full space-y-3'>
              {<DsInputMemo value={model.value} placeholder='Type here to test interactive state binding...' onChange={(e: React.ChangeEvent<HTMLInputElement>) => dispatch({ _tag: 'UpdateValue', value: e.target.value })} />}
          ...
          children: () => (
            <div className='w-full space-y-4'>
              ...
              <div>
                ...
                {<DsInputMemo size='normal' placeholder='Normal input field...' />}
              </div>
              <div>
                <span className='mb-1 block text-xs font-medium text-gray-500'>
                  Medium
                </span>
                {<DsInputMemo size='medium' placeholder='Medium input field...' />}
              </div>
              <div>
                <span className='mb-1 block text-xs font-medium text-gray-500'>
                  Large
              ...
              <div>
                ...
                {<DsInputMemo isRounded={true} placeholder='Search articles, tags, or authors...' />}
              </div>
            </div>
          ) })}
          ...
          children: () => (
            <div className='w-full space-y-4'>
              <div>
                ...
                {<DsInputMemo isError={true} value='invalid-email-address' placeholder='Enter valid email...' />}
              </div>
              <div>
                <span className='mb-1 block text-xs font-medium text-gray-500'>
                  Disabled State
                </span>
                {<DsInputMemo isDisabled={true} value='System read-only value' placeholder='Disabled...' />}
              </div>
            </div>
          ) })}
