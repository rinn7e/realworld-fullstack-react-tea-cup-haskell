...
import {  Container, Hero } from '@rinn7e/realworld-design-system'
      ...
      {Hero.view({
        ...
        children: () => (
          <>
            ...
            {<TitleMemo size={2} className='mb-2 font-extrabold text-gray-900' children={() => 'Container'} />}
        ...
        {sectionView({
          ...
          children: () => (
            <div className='w-full'>
              {Container.view({
                className:
                  'p-6 bg-gray-50 border border-gray-200 rounded text-center text-sm font-medium text-gray-700',
                children: () => 'Centering layout wrapper container' })}
            </div>
          ) })}
