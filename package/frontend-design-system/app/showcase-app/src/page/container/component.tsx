...
<><div className='mb-1 text-xs font-bold tracking-wider text-green-600 uppercase'>
            ...
            <DsTitleMemo size={2} className='mb-2 font-extrabold text-gray-900'>Container</DsTitleMemo>
        ...
        {sectionView({
          ...
          children: () => (
            <div className='w-full'>
              <DsContainerMemo
                className='p-6 bg-gray-50 border border-gray-200 rounded text-center text-sm font-medium text-gray-700'>Centering layout wrapper container</DsContainerMemo>
            </div>
          ) })}
