  ...
  return (
    <div data-component='HeroPage' className='w-full space-y-8 text-left'>
      <DsHeroMemo variant="default" size="small" className="rounded-lg bg-gray-50 border border-gray-200 px-6 py-6 w-full" children={() => (<><div className='mb-1 text-xs font-bold tracking-wider text-green-600 uppercase'>
            ...
            <DsTitleMemo size={2} className='mb-2 font-extrabold text-gray-900' children={() => 'Hero'} />
          ...
          children: () => (
            <div className='w-full'>
              <DsHeroMemo
                ...
                children={() => (
                  <DsTitleMemo size={2} className='text-white' children={() => 'Conduit RealWorld Hero Banner'} />
                )}
              />
            </div>
          ) })}
