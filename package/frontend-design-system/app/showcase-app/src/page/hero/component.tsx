...
<><div className='mb-1 text-xs font-bold tracking-wider text-green-600 uppercase'>
            ...
            <DsTitleMemo size={2} className='mb-2 font-extrabold text-gray-900'>Hero</DsTitleMemo>
            ...
            <div className='w-full'>
              <DsHeroMemo
                ...
                className='p-8 rounded-lg text-white text-center'>
                  ...
                  <DsTitleMemo size={2} className='text-white'>Conduit RealWorld Hero Banner</DsTitleMemo>
