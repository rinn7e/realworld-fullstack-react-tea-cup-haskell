...
const MediaObjectPageComponent = ({ model, dispatch }: Props) => {
  ...
  children: () => (
    <div>
      <h4 className='font-bold text-gray-900 dark:text-zinc-100'>Gerard Quan</h4>
      <p className='pt-1 text-sm text-gray-600 dark:text-zinc-400'>Great article explaining Elm Architecture in React and Haskell!</p>
    </div>
  ) })}`
          ...
          <div className='w-full'>
            ...
            >
              <div>
                ...
                <p className='pt-1 text-sm text-gray-600 dark:text-zinc-400'>
...
export const MediaObjectPageMemo = memo(
  MediaObjectPageComponent,
  PropsEq.equals,
)
