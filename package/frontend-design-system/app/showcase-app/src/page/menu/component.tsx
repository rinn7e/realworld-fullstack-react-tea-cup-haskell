...
const MenuPageComponent = ({ model, dispatch }: Props) => {
  const code = `{DsMenu.view({
  categories: [
      ...
      >
        <>
          ...
          <p className='text-base text-gray-600 dark:text-zinc-400'>
            Vertical sidebar navigation list with grouped categories and active
            item indicators.
          </p>
        </>
      </DsHeroMemo>
...
export const MenuPageMemo = memo(MenuPageComponent, PropsEq.equals)
