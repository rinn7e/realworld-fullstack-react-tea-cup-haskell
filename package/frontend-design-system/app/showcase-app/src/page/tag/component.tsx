...
const TagPageComponent = ({ model, dispatch }: Props) => {
      ...
      <div className='flex w-full flex-col gap-6'>
        ...
        >
          <div className='flex flex-col gap-4'>
            <div>
              <div className='pb-2 text-xs font-semibold tracking-wider text-gray-400 uppercase'>
                Solid
              </div>
...
export const TagPageMemo = memo(TagPageComponent, PropsEq.equals)
