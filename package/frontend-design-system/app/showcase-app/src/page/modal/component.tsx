...
const ModalPageComponent = ({ model, dispatch }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className='flex w-full flex-col gap-6'>
        ...
        <SectionViewMemo
          title='Rich Content Modal (Image, Badges, Typography & Footer Actions)'
...
export const ModalPageMemo = memo(ModalPageComponent, PropsEq.equals)
