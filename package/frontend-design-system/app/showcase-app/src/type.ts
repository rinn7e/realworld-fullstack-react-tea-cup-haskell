...
import type * as BlockPage from '@/page/block'
import type * as BoxPage from '@/page/box'
import type * as BreadcrumbPage from '@/page/breadcrumb'
import type * as ButtonPage from '@/page/button'
import type * as CardPage from '@/page/card'
import type * as CheckboxPage from '@/page/checkbox'
import type * as ColumnsPage from '@/page/columns'
import type * as ContainerPage from '@/page/container'
import type * as ContentPage from '@/page/content'
import type * as DeletePage from '@/page/delete'
import type * as DotLoadingPage from '@/page/dot-loading'
import type * as DropdownPage from '@/page/dropdown'
import type * as FieldPage from '@/page/field'
import type * as FilePage from '@/page/file'
import type * as FloatingSidebarPage from '@/page/floating-sidebar'
import type * as FooterPage from '@/page/footer'
import type * as HeroPage from '@/page/hero'
import type * as HomePage from '@/page/home'
import type * as IconPage from '@/page/icon'
import type * as ImagePage from '@/page/image'
import type * as InputPage from '@/page/input'
import type * as LevelPage from '@/page/level'
import type * as MediaObjectPage from '@/page/media-object'
import type * as MenuPage from '@/page/menu'
import type * as MessagePage from '@/page/message'
import type * as ModalPage from '@/page/modal'
import type * as NavbarPage from '@/page/navbar'
import type * as NotFoundPage from '@/page/not-found'
import type * as NotificationPage from '@/page/notification'
import type * as PaginationPage from '@/page/pagination'
import type * as PanelPage from '@/page/panel'
import type * as PopoverPage from '@/page/popover'
import type * as ProgressPage from '@/page/progress'
import type * as RadioPage from '@/page/radio'
import type * as SectionPage from '@/page/section'
import type * as SelectPage from '@/page/select'
import type * as SidebarPage from '@/page/sidebar'
import type * as TablePage from '@/page/table'
import type * as TabsPage from '@/page/tabs'
import type * as TagPage from '@/page/tag'
import type * as TextareaPage from '@/page/textarea'
import type * as TitlePage from '@/page/title'
